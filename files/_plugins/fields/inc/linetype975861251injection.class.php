...
class PluginFieldsLinetype975861251Injection extends PluginFieldsLinetype975861251 implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return LineType::getTypeName() . " - Тип подключения";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('LineType', 2);
