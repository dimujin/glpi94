...
class PluginGenericobjectObject extends CommonDBTM {
   ...
   static function getFieldsToHide() {
	   return ['id', 'is_recursive', 'is_template', 'template_name', 'is_deleted', 'notepad', 'date_mod', 'date_creation'];
//	   return ['id', 'is_recursive', 'is_template', 'template_name', 'is_deleted', 'entities_id', 'notepad', 'date_mod', 'date_creation'];
   }
...
//                  }
   ...
   **/
   ...
   function rawSearchOptions() {
      ...
      $datainjection_blacklisted = ['id', 'date_mod', 'date_creation'];
//      $index_exceptions = ['name' => 1, 'id' => 2, 'comment' => 16, 'date_mod' => 19, 'entities_id' => 80, 'is_recursive' => 86, 'notepad' => 90, 'date_creation' => 121];
      $index_exceptions = ['name' => 1, 'id' => 2, 'comment' => 16, 'date_mod' => 19, 'notepad' => 90, 'date_creation' => 121];
