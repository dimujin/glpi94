...
<html> 
<head>
<title>MyCloud - <?php echo __('Tickets','dashboard') .'  '. __('by Requester','dashboard');  ?></title>
...
<div id="titulo_graf" style="margin-bottom:45px;"> <?php echo __('Tickets','dashboard') .'  '. __('by Requester','dashboard').'s'  ?>  
