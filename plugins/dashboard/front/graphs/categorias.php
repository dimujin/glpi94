...
<html> 
<head>
<title>MyCloud - <?php echo __('Tickets','dashboard') .'  '. __('by Category','dashboard'); ?></title>
...
<div id="head" class="fluid">
	...
	<div id="titulo_graf" style="margin-bottom:45px;"> <?php echo __('Tickets','dashboard') .'  '. __('by Category','dashboard');  ?> 
